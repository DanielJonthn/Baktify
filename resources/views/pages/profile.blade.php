        ...
        <div class="bg-light p-5 rounded my-5">
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" id="description" name="description" aria-describedby="descriptionHelp" readonly></textarea>
                ...
                <div class="w-100 d-flex justify-content-end align-items-center">
                    <a class="btn btn-primary mx-3" href="#">Update</a>
